...
public class MongoApplication implements CommandLineRunner {
	...
	@Autowired
	public MongoApplication(PersonDAL personDAL) {
	...
	public void run(String... args) {
		...
		// UPDATE
		Person person = personDAL.findOneByName("David");
		person.setAge(21);
		person.setFavoriteBooks(Arrays.asList("Hunger Games", "Java"));
		personDAL.updateOnePerson(person);

		LOG.info("Updating David: \n{}",
				personDAL.findByName("David"));
